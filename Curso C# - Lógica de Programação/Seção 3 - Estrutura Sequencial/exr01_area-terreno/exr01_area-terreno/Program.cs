    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            valor_metragem = double.Parse(vet[2], CultureInfo.InvariantCulture);
            */
            ...
            Console.WriteLine("Largura = " + largura.ToString("F1", CultureInfo.InvariantCulture) + "m");
            Console.WriteLine("Comprimento = " + comprimento.ToString("F1", CultureInfo.InvariantCulture) + "m");
            Console.WriteLine("Valor do m² = R$" + valorMetroQuadrado.ToString("F2", CultureInfo.InvariantCulture) + "/m²");
            ...
            Console.WriteLine("Área = " + area.ToString("F2", CultureInfo.InvariantCulture) + "m²");
